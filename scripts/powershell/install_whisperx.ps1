...
$stages = @(
    ...
    @{ Name = "Install Dependencies"; Action = { Install-Dependencies $cfg; $Summary.DependenciesInstalled = $true } },
...
Write-Host ("Dependencies Installed  : {0}" -f $Summary.DependenciesInstalled)
